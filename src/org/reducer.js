...
const stateFunctions = {
	[orgActionTypes.ON_ORG_VALUE]: (state, payload) => ({ ...update(state, payload.path, () => payload.value) }),
	[orgActionTypes.ON_ORG_CHILD_ADDED]: (state, payload) => ({ ...update(state, payload.path, () => payload.value) }),
