...
const AboutPage = () => {
  return (
    <div>
      <h1>About</h1>
      <p>
        At CoffeeIQ we believe people should be engaged and happy at work, and
        we are building tools to help every company make that a reality.
      </p>
      <div>
        <h1>Team</h1>
        <div>
          ...
          are building a company that embodies these ideals while also
          instilling them in others.
        </div>
      </div>
    </div>
  );
