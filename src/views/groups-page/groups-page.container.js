...
const pageComponent = user => (
  <div className="groups-page">
    ...
    <h3>
      ...
      CoffeeIQ for <span className="capitalize">{user.orgName}.</span> Begin by
      joining a coffee group below - or make a new group for your team.
    </h3>
    <GroupList />
  </div>
);
...
const GroupsPage = ({ user }) => {
  return user.orgId === "gmail_com"
    ? noCompanyEmailMessage(user)
    : pageComponent(user);
};
